...
alias x='exit'
# sudo add/remove shortcuts
alias add='sudo apt-get install'
alias remove='sudo apt-get remove'
# start/stop LAMPP
alias serveron='sudo /opt/lampp/lampp start'
alias serveroff='sudo /opt/lampp/lampp stop'
alias cls='clear'
alias ..='cd ..'
alias ...='cd ../..'
# Directories shortcuts
alias docs='cd ~/Documents;ls -l --group-directories-first'
alias downs='cd  ~/Downloads;ls -l --group-directories-first'
alias toweb='cd /opt/lampp/htdocs;ls -l'
alias pics='cd ~/Pictures ls -l --group-directories-first'
